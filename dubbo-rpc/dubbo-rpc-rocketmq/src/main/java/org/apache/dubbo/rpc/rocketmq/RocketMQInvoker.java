...
public class RocketMQInvoker<T> extends AbstractInvoker<T> {
	...
	private RocketMQCountCodec dubboCountCodec = new RocketMQCountCodec(FrameworkModel.defaultModel());
	...
	protected Result doInvoke(Invocation invocation) throws Throwable {
		...
		try {
			...
			message.putUserProperty(TIMEOUT_KEY, (System.currentTimeMillis()+timeout)+"");
	...
	class DubboRequestCallback implements RequestCallback{
		...
		public void onSuccess(Message message) {
			try {
				...
				Object object =(Object)dubboCountCodec.decode(channel, heapChannelBuffer);
